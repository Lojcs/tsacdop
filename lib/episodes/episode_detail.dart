...
class _EpisodeDetailState extends State<EpisodeDetail> {
  ...
  Color get color =>
      context.trueBlack ? context.surface : episodeItem.cardColor(context);
  ...
  Widget _hiddenImage() => SliverAppBar(
    flexibleSpace: LayoutBuilder(
      builder: (context, constraints) {
        ...
        double expandRatio =
            ((topHeight - _titleBarMinHeight) / _titleBarMaxHeight).clamp(0, 1);
                ...
                child: Row(
                  children: [
                    episodeItem.versions == null
                        ? FutureBuilder(
                            future: episodeState.populateEpisodeVersions(
                              episodeId,
                            ),
